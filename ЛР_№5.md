...
|-------------------------|---------------------------------------------|---------------------------------------------|
| Верхній рівень          | My Computer (Мій комп’ютер)                  | Root directory (Кореневий каталог) `/`      |
| Доступ до пристроїв     | Пристрої мають літеру диска (C:, D: тощо)    | Пристрої змонтовані у каталоги, без літер   |
| Організація структури   | Дискові літери + папки                        | Єдина ієрархічна структура з каталогами     |
| Файли                   | Файли та папки (folders)                      | Все — файли (включно з пристроями)          |
| Кореневий каталог       | Відсутній (звернення через літеру диска)     | Кореневий каталог `/`                        |
| Навігація в CLI         | Команди `cd`, `dir`                           | Команди `cd`, `ls`                           |
| Приклад шляху           | `C:\Users\Username\Documents`                 | `/home/username/Documents`                   |
