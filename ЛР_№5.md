...
| Характеристика               | Windows-подібна система                          | Linux-подібна система                          |
|-----------------------------|-------------------------------------------------|-----------------------------------------------|
| Верхній рівень файлової системи | **My Computer** (Мій комп’ютер)                  | **Root directory** (Кореневий каталог), позначається `/` |
| Доступ до пристроїв          | Кожен пристрій має літеру диска (наприклад, C:, D:) | Пристрої доступні як каталоги у файловій системі, без літер дисків |
| Організація структури        | Деревоподібна структура з дисками і папками     | Ієрархічна структура каталогів, всі пристрої змонтовані у єдину деревоподібну структуру |
| Файли                       | Файли та папки (folders)                         | Все вважається файлами, включно з пристроями та каталогами |
| Кореневий каталог            | Відсутній, звернення через літеру диска          | Кореневий каталог — `/`                         |
| Командний рядок для навігації | Використання команд типу `cd`, `dir`              | Використання команд `cd`, `ls`                   |
| Приклади шляху              | `C:\Users\Username\Documents`                     | `/home/username/Documents`                      |
